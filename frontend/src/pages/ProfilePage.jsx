    ...
    <div className='flex gap-5'>
      ...
      <div className='w-52 shrink-0'>
        <div className='bg-white rounded-xl border border-gray-200 p-5 flex flex-col items-center text-center'>
          ...
          <p className='text-gray-400 text-xs mb-3 truncate w-full'>
            {user?.email}
          </p>

          <span
            className={`text-xs font-semibold px-2 py-0.5 rounded-full mb-4 ${roleStyles[user?.role]}`}
          >
            {user?.role}
          </span>
            ...
            <div className='space-y-4'>
              ...
              <div className='grid grid-cols-2 gap-4'>
                <div>
                  ...
                  <input
                    value={user?.employeeId || 'EMP-0042'}
                    readOnly
                    className='w-full border border-gray-200 rounded-lg px-3 py-2 text-sm text-gray-400 bg-gray-50 cursor-not-allowed'
                  />
                </div>
                <div>
                  ...
                  <input
                    value={user?.joinedAt || 'January 2024'}
                    readOnly
                    className='w-full border border-gray-200 rounded-lg px-3 py-2 text-sm text-gray-400 bg-gray-50 cursor-not-allowed'
                  />
                </div>
