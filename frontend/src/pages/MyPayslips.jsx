...
const MyPayslips = () => {
  ...
  if (loading) return (
    <div className="text-sm text-gray-400 py-10 text-center">Loading payslips...</div>
  );
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-5">
        ...
        {payslips.length === 0 ? (
          <p className="text-sm text-gray-400 text-center py-8">
            No payslips uploaded yet. Contact HR if you believe this is an error.
          </p>
        ) : (
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-100">
                ...
                <th className="text-left py-2 px-3 text-gray-500 font-medium">Uploaded</th>
